...
let degreeMap = [{ a: 0, b: 0 }, { a: 15, b: 20 }, { a: 30, b: 30 }, { a: 45, b: 35 }, { a: 50, b: 50 }, { a: 10, b: 10 }, // 爆裂之后的小水滴
{ a: 0, b: 0 // 爆裂之后不存在了
}];
...
class Drop {
  ...
  ishit() {
    ...
    for (let i = 0; i < dropArr.length; i++) {
      if (x <= dropArr[i].x + 50 + 10 && x >= dropArr[i].x - 50 - 10 && y <= dropArr[i].y + 50 + 10 && y >= dropArr[i].y - 50 - 10) {
        // 290 410 || 490 610
        // 225 250 250 250
